...
POI_UPDATES = [
    ("bor_zmarlych", 74, 8, "Bór Zmarłych",
    ...
    ("las_czarnych_drzew", 66, 20, "Knieja Czarnych Drzew",
...
NEW_LOCATIONS = [
    ...
    ("ostep_graniczny", "Ostęp Graniczny", 79, 33, "rural", 1, 1, "town", "trade-post",
    ...
    ("oboz_drwali", "Obóz Drwali", 60, 18, "forest", 2, 1, "town", "lumber-camp",
    ...
    ("smolarnia_na_palach", "Smolarnia na Palach", 78, 31, "swamp", 2, 1, "town", "tar-camp",
    ...
    ("stanica_wilcza", "Stanica Wilcza", 90, -3, "plains", 2, 1, "town", "hunter-camp",
     "Sezonowa stanica łowców wilków z Kresów, wbita w step. Futra, wnyki i psy; "
     "Wolfram zna każdą watahę po głosie."),
    ("szept_koron", "Szept Koron", 79, 13, "forest", 1, 1, "forest", "elven-hub",
    ...
    ("milczace_drzewo_1", "Milczące Drzewo — Smolny Konar", 67, 14, "forest", 2, 0, "forest", "extinct-warden",
    ...
    ("milczace_drzewo_2", "Milczące Drzewo — Rozdarta Pieśń", 72, 22, "forest", 2, 0, "forest", "extinct-warden",
    ...
    ("milczace_drzewo_3", "Milczące Drzewo — Siwy Strażnik", 63, 6, "forest", 3, 0, "forest", "extinct-warden",
    ...
    ("stare_gniazdo", "Stare Gniazdo", 71, 10, "forest", 3, 0, "ruin", "abandoned-elf-nest",
    ...
    ("utopiona_wies", "Utopiona Wieś", 81, 25, "swamp", 3, 0, "ruin", "drowned-village",
     "Ludzka wieś pochłonięta przez trzęsawisko — dachy sterczą z czarnej wody. Nocą "
     "świecą w niej ślepia utopców. Farmowalny loch."),
    ("polana_schizmy", "Polana Schizmy", 70, 16, "forest", 3, 0, "wilderness", "cursed-clearing",
    ...
    ("kurhan_wilczego_krola", "Kurhan Wilczego Króla", 95, -2, "plains", 3, 0, "tomb", "barrow",
    ...
    ("zarosniety_trakt", "Zarośnięty Trakt", 79, 37, "forest", 2, 0, "wilderness", "overgrown-road",
    ...
    ("czarne_serce", "Czarne Serce", 70, 8, "forest", 5, 0, "ruin", "myth-site",
