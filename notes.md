...
- [x] U4b — Playtest LLM 15 tur × 2 tryby skillem /game-smoke (ruch po hexach, NPC, quest, walka, sklep, odpoczynek+XP, beaty w Gotowej) — defekty P0/P1/P2; werdykt "brak P0" z U4 NIE jest jeszcze potwierdzony — [#512](https://github.com/szmidtpiotr/ai-gm/issues/512) [#513](https://github.com/szmidtpiotr/ai-gm/issues/513) **OBA NIEGRYWALNY — P0: #515 (scene_enemies), P1: #518 #519 #520 #521 #522**
  - SMOKE 2026-06-16 (przeglądarka/Playwright, nowa-kampania #99763): werdykt **GRYWALNY Z ZASTRZEŻENIAMI**. Działa: start+HUD, ruch/zmiana scen, start walki+inicjatywa+strefy, ataki wroga, zegar (09→10 na walce), ucieczka, spójność. Defekt **#712 P1** — atak gracza wręcz total 18 vs DEF 12 = pudło (loot nieosiągalny; możliwy P0 jeśli dotyczy każdego ataku ≥DEF). Checkpointy quest/sklep/odpoczynek/gate/lokacje-NPC z bazy = N/D (dziki start bez pobliskiej treści). Raport: [#713](https://github.com/szmidtpiotr/ai-gm/issues/713)
