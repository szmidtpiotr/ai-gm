...
- [x] [#504](https://github.com/szmidtpiotr/ai-gm/issues/504) — C10 QUEST_SUGGEST integracja: testy integracyjne pipeline parse→DB→snapshot (5/5 GREEN); poprawna analiza — C10 działa w ścieżce streaming, brakował test integracyjny potwierdzający pełny cykl; + Playwright 2/2 GREEN
