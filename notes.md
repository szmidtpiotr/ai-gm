...
- [x] [#756](https://github.com/szmidtpiotr/ai-gm/issues/756) — Quest dedup po celu: Jaccard word-similarity (≥0.65) w persist_quest_to_character_quests odrzuca duplikaty mimo innego tytułu; blok QUESTY wstrzyknięty do promptu LLM; reguła anty-duplikat w system_prompt.txt. TDD 6/6 + Playwright 2/2. Commit `0af61e2`. needs-testing
