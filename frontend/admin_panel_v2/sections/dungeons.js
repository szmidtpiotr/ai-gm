...
const TABS = [
    { key: "dungeons", label: "⚔ Lochy",    module: "/admin_panel_v2/sections/world.js?v=43", fn: "_renderDungeons" },
    { key: "riddles",  label: "🔮 Zagadki", module: "/admin_panel_v2/sections/world.js?v=43", fn: "_renderRiddles"  },
];
