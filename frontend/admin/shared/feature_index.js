...
export const FEATURE_INDEX = [
  ...
  { section:'map', sectionLabel:'Mapa', tab:'lint', title:'🩺 Kontrola świata', desc:'Lista rozjazdów w świecie (usługa bez gospodarza, sieroty obsady, heks bez lokacji, zepsuty rodzic, duplikaty) + guzik Napraw, naprawa masowa per reguła i kronika napraw.', keywords:'kontrola swiata lint rozjazdy naprawa integralnosc gospodarz sieroty duplikaty kronika napraw diagnostyka' },
