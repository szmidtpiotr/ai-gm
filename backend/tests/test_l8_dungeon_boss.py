        ...
        "graph": {
            ...
            "nodes": {
                ...
                boss_node: {
                    ...
                    "door_hints": {},
                    "content": {"is_boss_tile": True, "enemies": [], "room_description": "Boss room", "doors": ["N", "S"]},
                    "visited": True,
                    "cleared": False,
                    "is_boss": True,
                },
    ...
    return {
        ...
        "nodes": {
            entry: {
                ...
                "door_hints": {}, "content": {"is_boss_tile": False, "enemies": [], "doors": ["N", "S"]},
                "visited": False, "cleared": False, "is_boss": False,
            },
            boss: {
                "tile_id": 5, "position": [0, 1],
                "doors_open": {"N": entry, "S": None},
                "door_hints": {}, "content": {"is_boss_tile": True, "enemies": [], "doors": ["N", "S"]},
