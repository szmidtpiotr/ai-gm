...
from app.services.jwt_service import validate_session_token
...
def get_current_user(
    ...
    Raises HTTPException 401 when the token is absent, malformed, or expired.
    """
...
def get_current_user_optional(
    ...
    the legacy ?user_id= query param as a fallback.
    """
    if not authorization or not authorization.lower().startswith("bearer "):
        return None
