...
from app.routers.admin_location_duplicates import router as admin_location_duplicates_router
...
RAW_MIGRATIONS = [
    ...
    # #1411 — rzeka to bariera: przeprawa TYLKO przez most (bridge) lub bród (brod).
    # Wcześniej river.is_passable=1 → gracz przechodził rzekę jak ląd (bez sensu fabularnie).
...
app.include_router(admin_location_duplicates_router)  # #1409 — detektor duplikatów lokacji
